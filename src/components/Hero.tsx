...
export function Hero() {
  return (
    <>
      <section id="hero" className="flex flex-col items-center gap-12 md:gap-28 px-6 pt-20 pb-16 text-center">
        ...
        <div className="flex max-w-md flex-col items-center gap-8 text-center">
          ...
          <Button
            variant="solid"
            onClick={() =>
              document.getElementById('sobre-evento')?.scrollIntoView({ behavior: 'smooth' })
            }
          >
            Saiba Mais
          </Button>
